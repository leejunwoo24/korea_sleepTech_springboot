...
public class I_ORM {
    ...
    // >> DB오 테이블과 애플리케이션의 객체 사이의 구조적 불일치를 해결하는 솔루션;
    ...
    * */
    ...
    // +) 옵션 없이 사용 가능하나, 다른 애너테이션과 함꼐 기본키 생성 방식이나 타입 지정 가능
    ...
    // +) 옵션
    //      - name 옵션: 열 이름 지정
    //      - nullable 옵션: 열이 null 값을 헝ㅇ할지 여부를 설정 (기본값: true)
