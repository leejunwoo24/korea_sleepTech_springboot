...
public class GlobalExceptionHandler {
    ...
    // : 잘 못된 인자가 전달(IllegalArgumentException)되거나 DTO 검증 실패 시(MethodArgmuntNotValidException)
    // cf) @Vaild 에너테이션으로 오류 발생 시 MethodArgumentNotValidException
    ...
    // 403 - 권한 없음: 인증되지 않ㅇㄴ 사용자가 접근하려고 할 때 발생
