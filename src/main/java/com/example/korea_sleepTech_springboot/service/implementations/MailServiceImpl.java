...
//        body += "<a herf=\"http://localhost:8080/api/v1/auth/verify?token=" + token + "\"> 여기를 클랙하여 인증을 완료해 주세요"</a>"
    ...
    // : 내부에서 예외 발생 가능성이 있는 동기 코드(JWT 생성, 이메일 생성/발송 등)을 넣고 Mono로 감싸기
