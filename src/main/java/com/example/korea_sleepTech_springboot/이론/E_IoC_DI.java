    ...
    * */
    ...
    class BookStore1 {
        ...
        public BookStore1() {
            ...
            // >> 확장성, 유지보수성, 테스트에 어려움
            this.book = new Book1("Spring Boot 기준");
        }
    ...
    @Component
    // 해당 클래스를 spring bean으로 등록해라
    class BookStore2  {
        private Book2 book;

        // 스프링이 Book2 객체를 생성해서 자동으로 BookStore2에 넣어줌 (매개변수를 전달)
