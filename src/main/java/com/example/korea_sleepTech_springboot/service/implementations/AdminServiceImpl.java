...
public class AdminServiceImpl implements AdminService {
    ...
    public ResponseDto<PromoteToAdminResponseDto> promoteuserToAdmin(PutAuthorityToAdminRequestDto dto) {
    ...
    @Override
    public ResponseDto<DemoteFromAdminResponseDto> demoteUserFromAdmin(PutAuthorityToAdminRequestDto dto) {
