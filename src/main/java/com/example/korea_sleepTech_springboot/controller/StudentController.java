...
@RestController// @Controller + @ReponseBody 결합된 애너테이션: Restful 웹 서비스의 컨트롤러임을 명시
...
public class StudentController {
    ...
    /*
    * @Params(요청 - 매개변수): X
    * @Return(응답 - 반환값) : List<B_StudentDto>
    * */
    ...
    * @Return: StudentDto
    * */
    // "/student/{id}" 경로로 오는 GET 요청을 처리 {id}는 경로 변수로 사용된다.
    @GetMapping("/{id}")
